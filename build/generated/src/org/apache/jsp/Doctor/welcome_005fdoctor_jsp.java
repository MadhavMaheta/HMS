...
public final class welcome_005fdoctor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<b><h1 class=\"mainTitle\">Doctor | Dashboard</h1></b>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</section>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<h2 class=\"StepTitle\">View Appointments</h2>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p class=\"cl-effect-1\">\n");
      out.write("                                                                                            <a href=\"doc_apn.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t          Watch appointment\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p class=\"cl-effect-1\">\n");
      out.write("                                                                                            <a href=\"doc_apnHistory.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t          Watch appointment\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</p>\n");
