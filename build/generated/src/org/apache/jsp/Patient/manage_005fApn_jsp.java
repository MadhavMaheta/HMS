...
public final class manage_005fApn_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<head>\n");
      out.write("\t\t<title>Manage Apn </title>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<b><h1 class=\"mainTitle\">Patient | Appointment</h1></b>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</section>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<h2 class=\"StepTitle\">Book Appointment</h2>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p class=\"links cl-effect-1\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"updateprofile.jsp\">Book Appointment</a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<h2 class=\"StepTitle\">View Appointment</h2>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p class=\"cl-effect-1\">\n");
      out.write("                                                                                            <a href=\"patient_apnHistory.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t          Watch appointment history\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
